...
function Home() {
  ...
  return (
    <div className="h-screen z-20 absolute top-0 bg-[#F5F5F5]   w-screen text-black flex flex-col items-center justify-center ">
     <Nav/>

     <main className="min-h-screen text-black w-screen bg-[#F5F5F5]">
        <section className="w-screen flex pt-10 flex-col  justify-center items-center   h-[300px]  ">
        ...
        <section className="w-screen  flex flex-col items-center justify-start mt-1 h-[300px]  ">
            New Here: 
            {/* options */}
        ...
        {/* button */}
        <section  className="w-screen absolute bottom-10 flex items-center justify-center  h-[100px] bg-[#F5F5F5] mt-3  ">
          <div onClick={() =>{setPage("createRoom")}} className="bg-blue-500 cursor-pointer h-[60px] w-[60px] text-[30px] text-white flex items-center justify-center rounded-[50%] ">+</div>
        </section>
     </main>
    </div>
  );
