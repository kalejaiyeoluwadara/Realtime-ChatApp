...
function Menu() {
    const {nav,setNav,setPage,setIslight,isLight,room,setRoom,locRooms,setLocRooms,uniqueId } = useGlobal();
    ...
    className='w-screen z-50 text-white  fixed top-0 left-0   bo    ' >
        ...
        className={`min-h-screen ${isLight ? 'bg-[#F5F5F5] text-black ' : 'bg-gray-900 text-white' } relative   w-[290px] sm:w-[500px]  `} >
            ...
            <div className={`  ${isLight ? 'bg-white shadow-md text-black ' : 'bg-gray-800' } mb-2 h-[120px] flex gap-3 rb px-4 pt-8 `} >
                <img className='rounded-[50%] border-2 border-gray-500 h-[60px] w-[60px] ' src={genRandImage()} alt="" />
