...
function Chat({message,time,uniqueId}) {
  ...
  return (
    ...
    className={` container ${isLight ? 'border-gray-200  text-black ':'bg-gray-800 text-white '} transition duration-0.9 w-[96%]  sm:w-[500px] gap-4 flex flex-col items-start px-6 min-h-[150px]   py-4 shadow-md  rounded-[10px]     `} >
        ...
        <div className="body">
          <p className=' sm:text-[20px] lowercase text-[18px] font-[300] '>{message}</p>
        </div>
        <div className="foot">
